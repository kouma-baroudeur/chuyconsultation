<div id="dashboard" class="tab-content container px-6 mx-auto grid">
  ...
  <!-- CTA -->
  <a class="flex items-center justify-between p-4 mb-8 text-meduim font-semibold text-white bg-blue-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-blue" href="a_2y_10_RRW1ouCMC57VBrC0B60HH_EUPEjzQ1K35HAfrIK2cgay4qW2d7MEOskRdv">
  ...
  <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
    <!-- Card -->
    <a href="_2y_10_r13IGKtxD_GnnoFzdRU8seOhbPv6enWDRFDkaPoXmrinlcKUWlbOG">
    ...
    <!-- Card -->
    <a href="_2y_10_tg5iZO4vknyafZ_e4f6Qze7LkG8Pn3s9gM9cKNlvz_vPJP2_t0OFS">
      <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div class="-mx-1 -mb-1">
              <div class="flex flex-wrap" style="margin-bottom: -40px;">
                <template x-for="(day, index) in DAYS" :key="index">
                  <div style="width: 14.00%; height: 90px" class="px-6 py-6">
                    <div x-text="day" class="text-black text-sm uppercase tracking-wide font-bold text-center"></div>
                  </div>
                </template>
              </div>
              ...
              <div class="flex flex-wrap border-t border-l">
                <template x-for="blankday in blankdays">
                  <div style="width: 14.28%; height: 60px" class="text-center border-r border-b px-4 pt-2"></div>
                </template>
