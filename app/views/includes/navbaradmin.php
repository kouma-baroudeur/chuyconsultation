        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <a href="askRdv">
            <div class="px-6 my-6 mt-16">
              <button
                class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue"
              >
                <?=TAKERDV?>
      ...
      <aside
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <a href="askRdv">
            <div class="px-6 my-6 mt-16">
              <button
                class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue"
              >
                <?=TAKERDV?>
                <span class="ml-2" aria-hidden="true">+</span>
              </button>
