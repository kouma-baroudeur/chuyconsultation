<div id="dashboard" class="tab-content container px-6 mx-auto grid">
  ...
  <!-- CTA -->
  <!--a class="flex items-center justify-between p-4 mb-8 text-meduim font-semibold text-white bg-blue-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-blue" href="askRdv">
  ...
  <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
    <!-- Card -->
    <a href="profileStaff?id=<?= $_SESSION['userId'] ?>">
