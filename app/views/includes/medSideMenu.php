  ...
  <div class="sidenav-header">
    <div class="navbar-brand m-0 sidenav-toggler sidenav-toggler-inner row">
      <a href="javascript:;" class="nav-link text-body p-0 row">
        <div class="font-weight-bold align-start col-6 align-start">MENU</div>
        <div class="sidenav-toggler-inner wrap-none col-6 align-end">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= URLROOT ?>/medecins/chatapp" target="_blank">
          ...
          <span class="nav-link-text ms-1">Messagerie</span>
        </a>
      </li>
      <a class="btn bg-gradient-dark mt-4 w-80 mx-auto" href="<?= URLROOT ?>/users/_2y_10_AG_OSzHJ09ubMAfgTiWdM_Lw_aobUlVAr6Kw7bTOUMXEJPIMUn66W" type="button">Deconnexion</a>
    </ul>
  </div>
</aside>