<div class="container px-6 mx-auto grid">
    ...
    <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-blue-100 bg-blue-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-blue"
        href="layouts/registerPatient.php" >
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        <!-- Card -->
        <div
        class="flex items-center p-4 bg-white rounded-lg shadow-xl dark:bg-gray-800"
        >
        <div
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-xs">
                <span
                    class="px-2 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:bg-yellow-700 dark:text-yellow-100"
                >
                    hospitalised
                </span>
                </td>
