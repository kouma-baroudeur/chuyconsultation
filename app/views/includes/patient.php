<div class="container px-6 mx-auto grid">
  ...
  <a href="registerstaff">
    <button class="my-6 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">+Ajouter un patient
    </button>
  </a>
            ...
            <tr class="text-gray-700 dark:text-gray-400">
              ...
              <div class="flex items-center text-sm">
                  ...
                  <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                    <img class="object-cover w-full h-full rounded-full" src="<?= PAT ?>" alt="Doc PP" loading="lazy" />
                    <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                  </div>
                  <div>
                    <p class="font-semibold"><?= $personnel->nomPatient ?></p>
                  </div>
                </div>
              </td>
              <td class="px-4 py-3 text-sm">
                <?= $personnel->prenomPatient ?>
              </td>
              <td class="px-4 py-3">
                <?= $personnel->dateNaissancePatient ?>
              </td>
              <td class="px-4 py-3 text-sm">
                <?= $personnel->email ?>
              </td>
              <td class="px-4 py-3 text-sm">
                <?= $personnel->sexePatient?>
              </td>
              <td class="px-4 py-3">
                <div class="flex items-center space-x-4 text-sm">
                <a href="profilePatient?id=<?= $personnel->id ?>">
                <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-blue-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="profile" >
                  ...
                  <a href="modPatient?id=<?= $personnel->id ?>">
