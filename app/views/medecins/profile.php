...
<html lang="en">
    <head>
        ...
        <meta name="twitter:image" content="<?= URLROOT ?>/s3.amazonaws.com/creativetim_bucket/products/487/thumb/opt_sdp_thumbnail.jpg">
        <!-- Open Graph data -->
        <meta property="fb:app_id" content="655968634437471">
        <meta property="og:title" content="Soft UI Dashboard PRO by Creative Tim" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="<?= URLROOT ?>/dashboards/default.html" />
        <meta property="og:image" content="<?= URLROOT ?>/s3.amazonaws.com/creativetim_bucket/products/487/thumb/opt_sdp_thumbnail.jpg" />
        ...
        <script>
            ...
            })(window, document, 'script', '<?= URLROOT ?>/../../www.google-analytics.com/analytics.js', 'ga');
        ...
        <script>
            ...
            j.async = true;
            j.src =
                '<?= URLROOT ?>/../../www.googletagmanager.com/gtm5445.html?id=' + i + dl;
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <input id="firstName" name="firstName" value="<?=  $data['medecin']->nomMedecin ?>" class="form-control" type="text" placeholder="Alec" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <label class="form-label">Prenom</label>
                                            <div class="input-group">
                                                <input id="lastName" name="lastName" value="<?=  $data['medecin']->prenomMedecin ?>" class="form-control" type="text" placeholder="Thompson" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <select class="form-control" name="choices-gender" id="choices-gender" required>
                                                <option value="H" selected="false">Homme</option>
                                                <option value="F" selected="false">Femme</option>
                                            </select>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <label class="form-label mt-4">Date de Naissance</label>
                                            <div class="input-group">
                                                <input id="dateNaissance" name="dateNaissance" class="form-control" type="Date" value="" max="<?php echo date('Y-m-d'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <footer class="footer pt-3  ">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        ...
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            © <script data-cfasync="false" src="<?= URLROOT ?>/../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
