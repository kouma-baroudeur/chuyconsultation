                    ...
                    <div class="col-lg-6 col-md-8 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active " href="<?= URLROOT ?>/medecins/_2y_10_r2W8RrJ3iE_HI4y4H__wmexIpXZQtHTrBALAZqmpvTiz5FR4oiZ5W/<?= $data['id'] ?>" role="tab" aria-selected="true">
                                        ...
                                        <span class="ms-1">Dossier Medical</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " href="<?= URLROOT ?>/medecins/addConsultation/<?= $data['id'] ?>" role="tab" aria-selected="true">
                                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="<?= URLROOT ?>/medecins/premiereObservation/<?= $data['id'] ?>">
