...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <!-- Valeurs pour les statistiques  -->
            <input id="nbrPatientsMed" value="<?= $data['nbrPatientsMed'] ?>" hidden>
            <input id="nbrPatientsHopital" value="<?= $data['nbrPatientsHopital'] ?>" hidden>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Rendez-vous Attente</p>
                                ...
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-warning shadow text-center border-radius-md">
                                        <svg class="my-3" width="20px" height="20px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Rendez-vous a Venir</p>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Mes consultations</p>
                                        <h5 class="font-weight-bolder mb-0 text-info">
                                            <?= $data['nbrConsultationsMed'] ?>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-info shadow text-center border-radius-md">
                                        <svg class="mt-3" width="20px" height="20px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Mes Patients</p>
                                ...
                                <div class="col-4 text-end">
                                    <div class="icon icon-shape bg-gradient-success shadow text-center border-radius-md">
                                        <svg class="ms-2 mt-2" width="25px" height="25px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <title>patient</title>
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="row my-4">
                <div class="col-lg-8 col-md-6 mb-md-0 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body px-0 pb-2 mt-0">
            ...
            <div class="row mt-4">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-header p-3 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Rendez-vous</p>
                        ...
                        <div class="card-body mt-3 p-0">
                            <div class="chart">
                                <canvas id="chart-line-mini" class="chart-canvas" height="100"></canvas>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Patients Total</p>
                                            <h5 class="font-weight-bolder mb-0">
                                                <?= $data['nbrPatientsHopital'] ?>
                                            </h5>
                                        </div>
                                    </div>
                                    <span class="badge badge-dot d-block text-start pb-0 mt-3">
                                        <i class="bg-gradient-info"></i>
                                        <span class="text-muted text-xs font-weight-bold">Patients de l'hopital</span>
                                    </span>
                                    <span class="badge badge-dot d-block text-start">
                                        <i class="bg-gradient-secondary"></i>
                                        <span class="text-muted text-xs font-weight-bold">Mes patients</span>
                                    </span>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="card z-index-2">
                        <div class="card-header pb-0">
                            <h6>Statistics des Patients/Consultations</h6>
                            <p class="text-sm">
    ...
    <script src="<?= URLROOT ?>/assets/js/plugins/chartjs.min.js"></script>
    <script src="<?= URLROOT ?>/assets/js/plugins/sweetalert.min.js"></script>
    <script src="<?= URLROOT ?>/assets/js/plugins/datatables.js"></script>
    <script>
        var ctx1 = document.getElementById("chart-line-mini").getContext("2d");
        var ctx2 = document.getElementById("chart-bar").getContext("2d");

        var nbrPatientsHopital = document.getElementById("nbrPatientsHopital").value;
        var nbrPatientsMed = document.getElementById("nbrPatientsMed").value;
        ...
        new Chart(ctx2, {
            type: "doughnut",
            data: {
                labels: ['Patients Hopital', 'Mes Patients'],
                datasets: [{
                    label: "Patients",
                    weight: 9,
                    cutout: 50,
                    ...
                    data: [nbrPatientsHopital, nbrPatientsMed],
                    fill: false
                }],
            },
            options: {
    ...
    <script>
        ...
        gradientStroke1.addColorStop(1, 'rgba(130, 214, 22,0.2)');
        gradientStroke1.addColorStop(0.2, 'rgba(72,72,176,0.0)');
        gradientStroke1.addColorStop(0, 'rgba(130, 214, 22,0)'); //purple colors

        var gradientStroke2 = ctx2.createLinearGradient(0, 230, 0, 50);

        gradientStroke2.addColorStop(1, 'rgba(23, 193, 232,0.2)');
        gradientStroke2.addColorStop(0.2, 'rgba(72,72,176,0.0)');
        gradientStroke2.addColorStop(0, 'rgba(23, 193, 232,0)'); //purple colors
